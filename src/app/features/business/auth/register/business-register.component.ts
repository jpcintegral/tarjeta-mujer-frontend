...
export class BusinessRegisterComponent {
  ...
  onSubmit(): void {
    ...
    // DATOS
    //
    // EXACTAMENTE EL MISMO CONTRATO QUE WOMAN,
    // PERO CON:
    //
    ...
    this.authService.register(registerData).subscribe({
      next: (response) => {
        console.log('Business Owner registrado:', response);
      ...
      error: (error) => {
        console.error('Error registrando Business Owner:', error);
